...
function loadMusic(indexNumb) {
  ...
  musicImg.src = `../assets/mae/Images/${allMusics[indexNumb].img}.jpg`;
  mainAudio.src = `../assets/mae/Songs/${allMusics[indexNumb].src}.mp3`;
}
...
function updatePlayingDisk() {
  ...
  const playingDisk = document.querySelector(
    `.disk-container[index="${musicIndex}"]`
  );
  if (playingDisk) {
